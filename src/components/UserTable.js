              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right"><Badge label='Approved'></Badge></TableCell>
                    <TableCell align="right"><button style={{margin: '5px'}} type="button" class="btn btn-warning btn-sm">View</button><button type="button" class="btn btn-outline-dark btn-sm">Share</button></TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
